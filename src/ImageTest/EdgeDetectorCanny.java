...
public class EdgeDetectorCanny extends Component {
        ...
        public void process() throws EdgeDetectorCannyException {
               if (threshold < 0 || threshold > 255)
                       throw new EdgeDetectorCannyException("The value of the threshold is out of its valid range.");
               if (widGaussianKernel < 3 || widGaussianKernel > 40)
                       throw new EdgeDetectorCannyException("The value of the widGaussianKernel is out of its valid range.");
