...
public class EdgeDetectorRoberts {
	 int width;//图像宽
	 int height;//图像高
	 int[] grayData;//图像灰度值
	 int size;  //图像大小
	 ...
	 public EdgeDetectorRoberts(int threshold) {
	...
	// }// 计算像素点(x,y)Y方向上的梯度值
	 ...
	 public static void main(String[] args) {
		  EdgeDetectorRoberts test = new EdgeDetectorRoberts(50);//100
		  String imageName = System.getProperty("user.dir")+"/images/6.jpg";
		  String desImageName = System.getProperty("user.dir")+"/images/16.jpg";
		  try {
